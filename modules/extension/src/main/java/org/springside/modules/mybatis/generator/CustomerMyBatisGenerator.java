...
public class CustomerMyBatisGenerator {
     ...
     */
    public CustomerMyBatisGenerator(Configuration configuration, ShellCallback shellCallback,
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
        ...
        for (GeneratedXmlFile gxf : generatedXmlFiles) {
            ...
            try {
                ...
                if(isCanOverwrite(gxf.getFileName())){
                    continue;
                }
        ...
        for (GeneratedJavaFile gjf : generatedJavaFiles) {
            ...
            try {
                ...
                if(isCanOverwrite(gjf.getFileName())){
                    continue;
                }
                if (targetFile.exists()) {
                    if(!isCanOverwrite(gjf.getFileName())){
     ...
     * @return
     */
    private Boolean isCanOverwrite(String fileName){
