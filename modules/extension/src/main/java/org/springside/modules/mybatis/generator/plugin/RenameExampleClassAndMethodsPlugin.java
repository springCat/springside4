...
public class RenameExampleClassAndMethodsPlugin extends PluginAdapter {
    ...
    private String parameterFindString;
    ...
    public boolean validate(List<String> warnings) {
        ...
        parameterFindString = properties.getProperty(PARAM_SEARCH_PROPERTY);
        ...
        for (int i = 0; i < method.getParameters().size(); i++) {
            ...
            if (matcher.lookingAt()) {
                ...
                for (String annotation : parameter.getAnnotations()) {
                    newParam.addAnnotation(annotation.replaceAll(parameterFindString, parameterReplaceString));
                }
